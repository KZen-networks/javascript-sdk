          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                publicKey = _args6.length > 6 && _args6[6] !== undefined ? _args6[6] : null;
                signature = _args6.length > 7 && _args6[7] !== undefined ? _args6[7] : null;
                broadcast = _args6.length > 8 && _args6[8] !== undefined ? _args6[8] : true;
                ...
                _context6.next = 15;
                return this._prepareTransaction(msg, signMsg, fromAddress, sequence, memo, publicKey, signature);

              case 15:
                tx = _context6.sent;

                if (!(publicKey && signature && broadcast)) {
                  _context6.next = 18;
                  break;
                }

                return _context6.abrupt("return", this._broadcastDelegate(tx));
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                publicKey = _args11.length > 5 && _args11[5] !== undefined ? _args11[5] : null;
                signature = _args11.length > 6 && _args11[6] !== undefined ? _args11[6] : null;
