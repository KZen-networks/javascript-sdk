          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                sign = _args6.length > 6 && _args6[6] !== undefined ? _args6[6] : true;
                broadcast = _args6.length > 7 && _args6[7] !== undefined ? _args6[7] : true;
                ...
                _context6.next = 14;
                return this._prepareTransaction(msg, signMsg, fromAddress, sequence, memo, sign);
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                sign = _args11.length > 5 && _args11[5] !== undefined ? _args11[5] : true;
